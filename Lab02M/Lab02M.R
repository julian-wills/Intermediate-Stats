# Purpose: Lab 2, Exercise 2 Practice
# Date: 9/16/2016
...
setwd("/Users/Julian/GDrive/Misc/Classes/InterStats/Lab02M/")
...
cat("\n The mean of the sample is: ", CESD_mean)

CESD_median <- median(CESD_data$CESD)
cat("\n The median of the sample is: ", CESD_median)

CESD_mode <- mode2(CESD_data$CESD)
cat("\n The mode(s) of the sample is/are: ", CESD_mode)

CESD_var <- var(CESD_data$CESD)
cat("\n The sample variance is: ", CESD_var)

CESD_sd <- sd(CESD_data$CESD)
cat("\n The sample standard deviation is: ", CESD_var)

# You can also skip the intermediate steps if you prefer. The code below yields identical output to the code above. 

cat("\n The mean of the sample is: ", mean(CESD_data$CESD))
cat("\n The median of the sample is: ", median(CESD_data$CESD))
cat("\n The mode(s) of the sample is/are: ",  mode2(CESD_data$CESD))
cat("\n The sample variance is: ", var(CESD_data$CESD))
cat("\n The sample SD is: ", sd(CESD_data$CESD))
...
ggplot(CESD_data, aes(x = CESD)) + 
  geom_histogram(breaks=brx(CESD))
...
ggplot(CESD_data, aes(x = CESD)) + 
  geom_histogram(aes(y = ..density..), breaks=brx(CESD)) +
  xlab("CESD Scores") + 
  ylab("Density") + 
  ggtitle("Distribution of 20 CESD Scores") 
...
ggplot(CESD_data, aes(x = CESD)) + 
  geom_histogram(aes(y = ..density..), fill="grey", color="black", breaks=brx(CESD)) + 
  xlab("CESD Scores") + 
  ylab("Density") + 
  ggtitle("Distribution of 20 CESD Scores") +
  stat_function(fun=dnorm,
...
#  legend in the top right corner as well as rounded estimates of the mean, median, and standard deviation. 
ggplot(CESD_data, aes(x = CESD)) + 
  geom_histogram(aes(y = ..density..), fill="grey", color="black", breaks=brx(CESD)) + 
  stat_function(fun=dnorm,
                color="red",
...
ggplot(CESD_data_T, aes(x=CESD_c)) + 
  ...
  xlab("CESD Scores") + 
  ylab("Frequency") + 
  ggtitle("Distribution of 20 CESD Scores \n after Subtracting 10 and Dividing by 5")
